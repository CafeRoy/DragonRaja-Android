...
#define		CMD_LOCALWAR_END_CHAR_RESULT			26329
...
{
	BYTE	Data;
	char                        m_MuchKill_Char[20];
	char                        m_MuchDead_Char[20];
	char                        m_Mvp_Char[20];
	int                         m_TotalMvpPoint;
	int							m_MuchKill_Count;
	int							m_MuchDead_Count;
}	t_CommonDataC;
