...
int CheckHandleByKein( t_packet *p )
{
	...
	case  CMD_SEND_BANK2_INV		:	RecvBank2Inventory(&p->u.kein.server_bank_item); break;
    case CMD_BBS_KILLER             :   { RecvbbsKill(&p->u.kein.team_battle_msg2); }break;
		//		case CMD_SEND_CHAR_DISEASE		:	RecvCharDisease( &p->u.kein.server_disease ); break;	
	case CMD_PARTY					:	RecvParty( &p->u.kein.server_party ); break;			// �������� ��Ƽ���� ����� �����ش�
	...
	case CMD_TIDY_INVENTORY         :	RecvTidyInventory(p); break;
	...
	case CMD_SERVER_EACH_ITEM		:	RecvServerEachItem( &p->u.kein.server_item ); break;		// ������ �ڸ��� �������� ���� �ִ´�.
	...
	case CMD_EXCHANGE_ITEM			:	RecvExchange(); break;		// ��ȯ ����
	...
	case CMD_GET_CHARINFO_BY_KEIN	:	RecvCharInfoPlus( &p->u.kein.server_to_client_char_info_plus ); break;		// �߰� ĳ���� ���� �޾ƿ���
	...
	case CMD_NOT_EXIST_GAMESERVER:	ListenCommand = CMD_NOT_EXIST_GAMESERVER; break;
	...
	case CMD_THIS_MAN_IS_CANDIDATE_OK:	RecvCallRegistCandidate( ); break;		// �ĺ� ��� �޴� ����
	case CMD_THIS_MAN_IS_CANDIDATE_NOT:	RecvCallVoteSupport( p ); break;		// ��ǥ �޴� ����� ����� ��� �� ����ϱ� 
	...
	case CMD_REP_VOTE_SCORE			:	RecvVoteScore( p ); break;		// �ĺ� ��ǥ ���� ��������
	case CMD_GET_SKILL_INFO			:	RecvGetSkillInfo( p ); break;
		
	case CMD_RECV_ALL_MSG			:	RecvNationMassage( p );break;
		
	case CMD_YOU_ARE_KING_LOG2CLIENT:	RecvYouAreKing( 1 ); break;		// ������ ����� �ش�.
	case CMD_YOU_ARE_NO_KING_LOG2CLIENT	: RecvYouAreKing( 0 ); break;		// �տ��� �����Ѵ�.
		
	case CMD_GUILD_EXIT_YOU			:	RecvGuildExistYou( ); break;		// ��忡�� Ż����� ���
	case CMD_GUILD_EXIT_OK			:	RecvGuildExistOk(  p ); break;			// ��� Ż���� ����
	case CMD_GUILD_EXIT_WHO			:	RecvGuildExistWho(  p ); break;			// ��� Ż���� ����
		
		
	case CMD_GUILD_JOIN_SERVER_OK	:	RecvGuildJoinOk( p ); break;
	case CMD_GUILD_JOIN_SERVER_NOT	:	RecvGuildJoinFail( p ); break;			// ���� ��Ű�� �� �����ߴ�.
		
	case CMD_GUILD_JOIN_CONFIRM		:	RecvGuildJoinConfirm( p ); break;		// yes no ���� �ʿ�
	...
	case CMD_CHANGE_MONEY_OK		:	RecvChangeMoney( p ); break;
		...
		//		case CMD_ALL_TEAM_MEMBER_VIEW	:	RecvAllTeamInfo( p ); break;		// ����Ʋ�� ������ ��� ����� ������ �����ش�.
		//		case CMD_ADD_TEAM_MEMBER_INFO	:	RecvAddMemberInfo( p ); break;		// ���� �߰��� ���� ����
