 ...
 * @brief	Warfield MapServer Port �ĺ���.
 */
//< LTH-040120-KO.
typedef enum _eWARFIELD_PORT
{
	WP_BASE_PORT			= BASE_WARFIELD_PORT,	/**< �⺻�� �Ǵ� ������ ��Ʈ. */
	WP_MOUNTAIN_WARFIELD	= 5991,					/**< ���� ������. */
	WP_PLAIN_WARFIELD		= 5992,					/**< ��� ������. */
	WP_ISLAND_WARFIELD		= 5993,					/**< �� ������. */
	WP_SNOWY_WARFIELD		= 5980,					/**< ���� ������. */
	WP_HADES_WARFIELD		= 5994,					/**< ���� ������. */
	WP_MAX_WARFIELD_PORT	= 5995,					/**< �ִ� ������ ��Ʈ ��ȣ. */
} eWARFIELD_PORT;									/**< ������ ��Ʈ ��ǥ enum group. */
//> LTH-040120-KO
...
{
	WI_MOUNTAIN_WARFIELD	= 0,	/**< ���� ������	(5991 - BASE_WARFIELD_PORT = 0). */
	WI_PLAIN_WARFIELD		= 1,	/**< ��� ������	(5992 - BASE_WARFIELD_PORT = 1). */
	WI_ISLAND_WARFIELD		= 2,	/**< �� ������		(5993 - BASE_WARFIELD_PORT = 2). */
	WI_SNOWY_WARFIELD		= 3,	/**< ���� ������	(WI_ISLAND_WARFIELD + 1 = 3). */
	WI_HADES_WARFIELD		= 4,	/**< ���� ������	(5994 - BASE_WARFIELD_PORT + 1= 4). */
	WI_MAX_WARFIELD			= 5,	/**< �ִ� ������ ����. */
} eNEO_WARFIELD_ID;					/**< ������ ��ȣ ��ǥ enum group. */
//> LTH-040126-KO
...
#define	NW_SOPEN						11				// LTH-040226-KO ������� ����
...
//#define		MAX_NEW_WARFIELD				1		// LTH-040226-KO ���� �ֱ⶧���� ������.
...
public :
	...
	void SetTileDont(int WarfieldNo,int MonNo,int type); //���� SQL �ʵ� INDEX, 0,1 : 
