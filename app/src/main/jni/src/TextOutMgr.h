...
#endif // _MSC_VER > 1000
//020828-2 lsw
const int TXT_BG_SHORT_WIDTH	= 140;//150 ���� 
const int TXT_BG_NORMAL_WIDTH	= 192;//200 ����
const int TXT_BG_LONG_WIDTH		= 240;//250 ����
const int TXT_BG_VERY_LONG_WIDTH= 290;//300 ����
...
const int BG_HEIGHT				= 14;//14�� �ȹٲ�� �ϼ���//��� �����°� ������ �׷����ϴ�.
...
public:
	...
	void PutTextHeaderBGImg(const int iExplainX, const int iExplainY, const int iWidth);//�׸� ���� �׵θ�.
	void PutTextTailBGImg(const int iExplainX, const int iExplainY, const int iWidth);//�׸� �Ʒ� �׵θ�.
