...
protected:
	...
	bool g_center_hero = true;
	bool g_block_move = false;
	bool g_block_skill = false;//020821 lsw
	bool g_block_attack = false;
	bool g_block_magic = false;
	bool g_block_GiveLife = false;
	bool g_block_anti_team = false;
	bool g_absolute_move = false;
	bool g_absolute_move_dk = false;
	bool g_absolute_logout = false;
	bool g_make_ghost = false;
	bool g_give_life = false;

	LPCHARACTER lpAbsoluteMoveCh = nullptr;
	bool		AbsoluteMoveFlag = false;
	bool		AbsoluteMoveDKFlag = false;

	int			ViewTipsFlag = false;
