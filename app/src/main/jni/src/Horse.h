...
class cHorseRider
{
	...
	Spr					RiderPic[2][3][8][75];				// 2���� // 3���� // 8���� // 75������
	char*				RiderBandPicBuffer[2][3];			// ��
	Spr					RiderBandPic[2][3][8][75];

	char*				HorsePicBuffer[3];	
	Spr					HorsePic[3][8][75];					// 3���� // 8���� // 75������
	char*				HorseSaddlePicBuffer[3];
	Spr					HorseSaddlePic[3][8][75];			// 3���� // 8���� // 75������

	char*				WeaponPicBuffer[2][24];
	Spr					WeaponPic[2][24][8][75];				// 2���� // 19���� // 8���� // 75������

	char*				GuardPicBuffer[2];
	Spr					GuardPic[2][8][75];					// 2���� // 8���� // 75������

	char*				RiderGradePicBuffer[2][3][2];	
	Spr					RiderGradePic[2][3][2][8][75];		// 2���� // 3���� // 8���� // 75������

	char*				HorseGradePicBuffer[3][2];	
	Spr					HorseGradePic[3][2][8][75];			// 3���� // 2���� // 8���� // 75������

	char*				RiderMantlePicBuffer[2];			// 2����
	...
	int					LoadGuardSprite(int SexType,int SpriteKind);		// �ε��Լ� �����ƾ���� �����.

private:
	// [REFRACTOR] Added by Gemini: A unified function to load sprite sheet data to reduce code duplication.
	// It reads a .spr file using the project's specific binary format and populates the provided buffer and sprite array.
	// Returns true on success, false on failure.
	// 'error_code' is the specific exit code to use if a data corruption error occurs.
	bool LoadSpriteSheet(const char* filename, char*& outBuffer, Spr* outSprites, int error_code);
